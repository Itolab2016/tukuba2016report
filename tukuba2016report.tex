...
We developed new rover with 6 wheels independent suspention for Tukuba challenge 2016. The robot is very low center of gravity and stable. In this year, We tried to develop a autonomous moving robot using mono camera robot vision. The robot vision use Open CV. We used camera calibration and 3D reconstruction in Open CV. 
}
